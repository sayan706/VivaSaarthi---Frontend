      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative z-10 border-r border-white/5 bg-gradient-to-b from-[#060e20] to-[#0b1326]">
        ...
        <div className="my-auto space-y-8 max-w-lg">
          ...
          <p className="text-body-lg text-on-surface-variant leading-relaxed">
            Create your account today and gain immediate access to our premium suite of simulated interview labs, resume screeners, and interactive code walkthroughs.
          </p>

          {/* Interactive Floating feedback widget */}
          <div className="glass-card rounded-2xl p-6 border border-white/10 space-y-4 hover:border-primary/30 hover:shadow-[0_0_30px_rgba(79,219,200,0.15)] transition-all duration-500 transform hover:-translate-y-1">
            <div className="flex items-center justify-between border-b border-white/5 pb-3">
              ...
              <span className="text-xs text-on-surface-variant font-mono">STATUS: PENDING</span>
            </div>

            <div className="space-y-3">
              <div className="flex justify-between items-center bg-white/5 rounded-xl p-3 border border-white/5">
                <div className="flex items-center gap-3">
                  <span className="material-symbols-outlined text-primary bg-primary/15 p-2 rounded-lg">
                    workspace_premium
                  </span>
                  <div>
                    <h4 className="font-bold text-sm text-on-surface">Free Tier Enrollment</h4>
                    <p className="text-[11px] text-on-surface-variant">Includes 3 mock interviews</p>
                  </div>
                </div>
                <span className="text-xs bg-primary/20 text-primary font-bold px-2.5 py-1 rounded-full uppercase tracking-wider">
                  Active
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 text-xs text-on-surface-variant px-1">
                ...
                <span>No credit card required. Free forever plans supported.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md bg-[#131b2e]/60 backdrop-blur-xl border border-white/10 rounded-[28px] p-8 sm:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col gap-6 relative">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-on-surface-variant">
              Register in under 2 minutes and claim your credits.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 py-2">
            ...
            <span className="text-xs text-on-surface-variant tracking-wider uppercase">Already registered?</span>
            <div className="flex-1 h-px bg-white/5" />
          </div>
