    ...
    <div className="p-2 md:p-8 max-w-[1600px] mx-auto w-full">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
        <div>
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900">Interview Reports</h2>
          <p className="text-sm md:text-base text-gray-500 mt-1">Review all your past mock interviews and track your progress.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
        {loading ? (
                ...
                <div key={session.id} className="p-4 flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg bg-gray-100 flex items-center justify-center text-gray-500 shrink-0">
                      <i className={`ph ${String(session.template_id)?.includes('frontend') ? 'ph-code' : 'ph-briefcase'} text-lg`}></i>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      {session.overall_score ? (
                        <span className="text-gray-900 font-bold text-xs">{session.overall_score}/100</span>
                      ) : (
          ...
          <div className="flex flex-col items-center justify-center p-8 md:p-12 text-center h-64">
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-gray-50 flex items-center justify-center mb-4 border border-gray-100">
              <i className="ph ph-tray text-3xl md:text-4xl text-gray-300"></i>
            </div>
            <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">No Reports Found</h3>
